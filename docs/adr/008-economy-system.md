...
| 항목 | 상태 |
|---|---|
| 블라인드 클리어 시 기본 보상이 정확히 지급된다 | ✅ 완료 |
| 남은 핸드당 $1 보너스가 정확히 계산된다 | ✅ 완료 |
| 이자가 $5당 $1, 최대 $5로 정확히 계산된다 | ✅ 완료 |
| 아이템 구매 시 자금이 정확히 차감된다 | ✅ 완료 |
| 아이템 판매 시 판매가가 정확히 추가된다 | ✅ 완료 (sellJoker) |
| 현재 보유 자금이 UI에 항상 표시된다 | ✅ 완료 |
